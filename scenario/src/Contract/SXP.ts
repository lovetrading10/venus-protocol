...
export interface SXPScenarioMethods extends SXPMethods {
...
export interface SXP extends Contract {
  methods: SXPMethods;
  name: string;
}

export interface SXPScenario extends Contract {
  methods: SXPScenarioMethods;
  name: string;
}
